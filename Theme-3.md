...
```
#### Результат:
![image](https://github.com/CauseLove7/Program-Engineering/assets/145790904/30709489-80ab-4590-8077-0f51c710f5f0)

#### Вывод: В данном коде цикл 'for' дважды прогоняет число 1 через две математические операции, *6 и +2, после чего подает результат, равный 50, на вывод.
...
```
#### Результат:
![image](https://github.com/CauseLove7/Program-Engineering/assets/145790904/f4772054-6aac-48ea-8f3e-9477d463fa1a)
#### Вывод: Результатом данного кода будет перевернутая фраза.
...
#### Результат:
Вариант 1:
![image](https://github.com/CauseLove7/Program-Engineering/assets/145790904/a6a7af87-a5af-4d6e-bf54-b788adf71ab1)
Вариант 2:
![image](https://github.com/CauseLove7/Program-Engineering/assets/145790904/7a780e1a-719b-477e-a174-4f840ad9a440)
Вариант 3:
![image](https://github.com/CauseLove7/Program-Engineering/assets/145790904/a5575b62-4bc6-4add-b571-74b85292fc99)
Вариант 4:
![image](https://github.com/CauseLove7/Program-Engineering/assets/145790904/1d10dd58-0c4d-4d20-b96b-264c3c503857)
...
```
#### Результат:
![image](https://github.com/CauseLove7/Program-Engineering/assets/145790904/5fd18bc2-9dab-4b61-a057-ead3ccf36459)
...
```
#### Результат:
![image](https://github.com/CauseLove7/Program-Engineering/assets/145790904/b6895d44-5ac9-4589-9a5a-a51daed6b63f)
#### Вывод:
Мы объявляем строковую переменную с именем "string", массив чисел под названием "values" и устанавливаем счетчик "counter" равным 0. Затем, в рамках цикла "while", выполняется следующий процесс: пока строка "string" не содержит слово "world" и значение счетчика "counter" меньше 10, программа выводит сначала "hello world" на одной строке, а затем "hello" на следующей строке. Когда значение счетчика достигнет 10, будет выведена фраза "hello world", а "hello" больше не будет выводиться, после чего цикл завершит свою работу.
